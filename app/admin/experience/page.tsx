              ...
              {experiences.length === 0 ? (
                <tr>
                  <td colSpan={4} className="px-8 py-16 text-center">
                    <p className="text-gray-400 font-medium text-lg">No experience records found.</p>
                    <p className="text-gray-400 text-sm mt-1">Add your first role to get started.</p>
                  </td>
                </tr>
              ) : (
                experiences.map((exp: any, index: number) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-5 font-mono text-[11px] text-gray-500 tracking-tight">
                      {exp.year}
                    </td>
