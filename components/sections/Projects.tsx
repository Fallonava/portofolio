        ...
        <section id="projects" className="py-24 bg-background relative z-10">
            <div className="container mx-auto px-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
                    {/* Project 1 */}
                    <Link href="https://app.fallonava.my.id" target="_blank" className="block group">
                        <SpotlightCard className="h-full flex flex-col justify-between" spotlightColor="rgba(26, 115, 232, 0.2)">
                            <div className="mb-6">
                    ...
                    {/* Project 2 */}
                    <Link href="https://display.fallonava.my.id" target="_blank" className="block group">
                        <SpotlightCard className="h-full flex flex-col justify-between" spotlightColor="rgba(236, 72, 153, 0.2)">
                            <div className="mb-6">
                                <div className="flex justify-between items-start mb-4">
